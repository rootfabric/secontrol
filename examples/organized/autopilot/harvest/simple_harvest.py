...
def main() -> None:
    ...
    try:
        ...
        # Смещение зоны вниз на 30 метров
        current_offset = props.get("Drill.AreaOffsetUpDown", 0)
        if isinstance(current_offset, (int, float)):
            # drill.set_property("AreaOffsetUpDown", current_offset + 30)
            drill.set_property("AreaOffsetUpDown", offset)
